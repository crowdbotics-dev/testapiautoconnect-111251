...
## Project Structure
    ...
    ├── testapiautoconnect_111251  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_111251`
...
2. Clone this repo and `cd testapiautoconnect_111251`
